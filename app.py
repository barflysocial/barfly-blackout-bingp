...
def clone_game(source):
    ...
    clone = Game(
        ...
        rsvp_open_at=source.rsvp_open_at,
        rsvp_close_at=source.rsvp_close_at,
        ...
        status='draft' if source.rsvp_open_at and source.rsvp_open_at > datetime.utcnow() else 'rsvp',
