...
## v2.10 WIN Sticky Header Fix
- WIN header now renders outside the battle row grid.
- WIN header remains sticky under the power slots.
- Only numbered board rows scroll/collapse.
